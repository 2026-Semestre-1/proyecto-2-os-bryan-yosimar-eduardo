...
public class Instruccion {
    ...
    public Instruccion(String pInstruccion_Completa) {
        ...
        while (m.find()) { String token = m.group(); partes.add(token); }
    ...
    public String getInstruccion_ASM() { return Instruccion_ASM; }
    public void setInstruccion_ASM(String Instruccion_ASM) { this.Instruccion_ASM = Instruccion_ASM; }
    public String getRegistro_Destino() { return Registro_Destino; }
    public void setRegistro_Destino(String Registro_Destino) { this.Registro_Destino = Registro_Destino; }
    ...
    public String getInstruccion_Completa_Original() { return Instruccion_Completa; }

    public String get_Intruccion_Completa() {
        return this.Instruccion_ASM + " " + (this.Registro_Destino != null ? this.Registro_Destino.toString() : " ") + " " + (this.Operando1 != null ? "," + this.Operando1.toString() : " ") + " " + (this.Operando2 != null ? "," + this.Operando2.toString() : " ");
    }

    @Override
    public String toString() {
        return "Instruccion: -> " + "Instruccion_ASM = " + Instruccion_ASM + ", Registro_Destino = " + Registro_Destino + ", Operando1 = " + Operando1 + ", Operando2 = " + Operando2;
    }

    public void mostrar_Instruccion_Completa_Original() { System.out.println(getInstruccion_Completa_Original()); }
}
